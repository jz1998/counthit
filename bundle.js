...
class EmojiReaction extends s {
  ...
  static styles = i$1`
    ...
    .container {
      ...
      --reaction-got-not-reacted-bg-color-default: #eaeef2;
      --reaction-got-not-reacted-bg-color-hover-default: #d9d9d9;
      ...
      --reaction-available-popup-bg-color-default: #eaeef2;
    ...
    .container-dark {
      ...
      --reaction-got-not-reacted-bg-color-default: #21262d;
  ...
  render() {
    ...
    <div style="flex-wrap: nowrap; max-width: 100%; display: flex; justify-content: center;  gap: 0.375rem; height: 1.5rem;" class="${this?.theme === 'dark' || (this?.theme === 'system' && system_theme === 'dark') ? 'container-dark' : 'container'}">
      <div style="position: relative; user-select: none; display: flex;">
        <div class="anim-scale-in reaction-available-popup" @click=${this._closePopup} style="display: flex; user-select: none; position: absolute; top: -3rem; font-size: 0.875rem; border-radius: 0.375rem; padding: 0 0.125rem;">
          <!-- reactions available -->
      ...
      <div style="display: flex; gap: 0.375rem;">
        ${this.availableReactions.map(item => x`
          <div @click=${this._react} data-name="${item.reaction_name}" class="${item.meReacted ? 'reaction-got-reacted' : 'reaction-got-not-reacted'}" style="display: ${item?.count && item.count >= 0 ? 'flex' : 'none'}; user-select: none; cursor: pointer; justify-content: center; align-items: center; padding: 1.25rem; font-size: 1.75rem;">
